...
Sandboxing is experiencing a major renaissance due to:
- LLM-generated code  
- Serverless workloads  
- Increased security requirements  
- Lightweight OS trends  

Each sandboxing model fills a unique niche:

- **Namespace sandboxes** → speed & low overhead  
- **Containers**
